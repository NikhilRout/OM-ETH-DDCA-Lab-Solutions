...
HD_PWD='C:/Xilinx/Projects/lab2/lab2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RCAtoSevenSeg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RCAtoSevenSeg.tcl -notrace
