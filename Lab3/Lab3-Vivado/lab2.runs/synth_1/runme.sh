...
HD_PWD='C:/Xilinx/Projects/lab2/lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RCAtoSevenSeg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RCAtoSevenSeg.tcl
